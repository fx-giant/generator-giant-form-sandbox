...
var targets = {
	SIT: "http://172.16.53.228/WebSites/Analytics/api/FormPack/Upload",
}

var zipName = "<%= formName %>";
...
function startUpload() {
	zipTheFormPack(uploadFile);
}

function startSave() {
	zipTheFormPack(savePack);
}

function zipTheFormPack(callback) {
